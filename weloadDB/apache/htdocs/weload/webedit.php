...
echo "<b>Derzeit k&ouml;nnen Sie lediglich den Aufbau der imsmanifest.xml betrachten.</b><br>";
echo "F&uuml;r weitergehendes Editieren verwenden Sie bitte den RELOAD-Editor.<br>";
echo "Bis zur Version 1.0 sind weitere Features in Planung.<br>";
...
echo "Keine imsmanifest.xml vorhanden!";
}
if ($_SESSION['admin']!="admin") {
echo "<P><FONT FACE=\"Arial,sans-serif\">";
