...
echo "Bitte einen Namen f&uuml;r das Content Package eingeben!";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=Zur&uuml;ck></FORM>";
exit;
}
if ($verz == "uploads" or $verz=="Uploads" or $verz=="upload" or $verz=="Upload") {
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "Die Namen \"upload\" und \"uploads\" sind leider reserviert!";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=Zur&uuml;ck></FORM>";
exit;
}
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "Content Package existiert bereits!<br>";
echo "<br>";
echo "<br>";
echo "<form action=\"overwrite.php?pfad=$verz method=post\">";
echo "<div>";
echo "<button name=\"Löschen\" type=\"button\" value=\"$verz\" onClick=\"self.location.href='overwrite.php?pfad=$verz'\">";
echo "<img src=\"../images/refresh.gif\" border=0\" alt=\"Content Package &uuml;berschreiben\">";
echo "</button>&nbsp; &nbsp; &nbsp; &Uuml;berschreiben";
echo "</div>";
echo "</form>";

echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=Abbrechen></FORM>";
exit;
}
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "Das Content Package ist leer.<br>";
echo "Sie m&uuml;ssen zuerst Dateien und/oder Links einstellen.<br>";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=Zur&uuml;ck></FORM>";
exit;
}
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "<H1>Konvertierung erfolgreich</H1>";
echo "<HR>";
echo "<H2><A HREF=\"$pfad\" target=\"_blank\">Content Package anschauen</A><br>";
echo "</H2>";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
