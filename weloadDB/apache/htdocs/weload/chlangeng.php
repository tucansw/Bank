...
echo "Englische Version von WeLOAD wird bereitgestellt!</H2><br>";
echo "Kopiere die erforderlichen Dateien...";
$dr=$_SERVER['DOCUMENT_ROOT'];
$weloadeng ="$dr/languages/english/";
$reloadkram="$dr/cp/";
$weloadengpreview ="$dr/languages/english/ContentPreview/";
$cp="$dr/cp/";
...
$web="weload/";
$stick="$http$ipnummer2$web";
echo "<b><A HREF=\"$stick\"target=\"_blank\" >English version of WeLOAD (new window)</b></A>";
