...
$zipname="$y.zip";
if(is_file($zipname)){
echo "Datei wurde überschrieben!";
unlink ($zipname);
}
rename ($copy1,$zipname);
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "<H1>Zippen erfolgreich</H1>";

echo "<H2><A HREF=\"/weload/zipped/$zipname\" target=\"_blank\">$zipname runterladen</H2></A>";
echo "<form enctype=\"multipart/form-data\" action=\"webverwaltung.php\" method=\"post\">";
echo "<P><INPUT type=submit value=Zur&uuml;ck></FORM></P>";
echo "<HR>";
