...
echo "<H2>Manage Content Packages</H2>";
$dr=$_SERVER['DOCUMENT_ROOT'];
$path = "$dr/weload";
$var = diskfreespace("$path");
$laenge=strlen($var);
$var1 = substr($var,0,$laenge-6);
echo "Free diskspace on WeLOAD: " . $var1 . " Megabyte";
echo "<br>";
...
echo "			</TH>";
echo "			<TH WIDTH=20%>";
echo "				<P><FONT FACE=\"Arial,sans-serif\">Edit</FONT></P>";
echo "			</TH>";
echo "			<TH WIDTH=20%>";
echo "				<P><FONT FACE=\"Arial,sans-serif\">Zip</FONT></P>";
echo "			</TH>";
echo "			<TH WIDTH=40%>";
echo "				<P><FONT FACE=\"Arial,sans-serif\">Delete</FONT></P>";
echo "			</TH>";
echo "		</TR>";
echo "	</THEAD>";
echo "  <TBODY>";
...
echo "<img src=\"../images/editweb.gif\" border=0\" alt=\"Edit Content Package\">";
echo "</button>";
echo "</div>";
echo "</form>";
echo "			</TD>";
...
echo "<img src=\"../images/zip.gif\" border=0\" alt=\"Zip Content Package\">";
echo "</button>";
echo "</div>";
echo "</form>";
echo "			</TD>";
...
echo "<img src=\"../images/deldir.gif\" border=0\" alt=\"Delete Content Package\">";
echo "</button>";
echo "</div>";
echo "</form>";
echo "			</TD>";
...
unlink ($liste);
echo "<br>";
echo "<FONT FACE=\"Arial, sans-serif\"><FONT SIZE=4>Upload zipped Content Package from RELOAD</FONT></FONT>";
...
echo "<hr>";
echo "<a href=\"http://www.contake.at\" target=\"new\"> <IMG SRC=\"../images/contake_logo.jpg\" NAME=\"Contake Logo\" ALIGN=MIDDLE BORDER=0></a>&nbsp;&nbsp;&nbsp;Con&#8226;take: Search for learning objects, Tiroler Bildungsservice";
