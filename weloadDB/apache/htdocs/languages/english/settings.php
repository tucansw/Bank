...
echo "      <P ALIGN=CENTER><FONT FACE=\"Arial, sans-serif\"><A HREF=\"chpw.php\">Change password";
echo "			</A></FONT></P>";
echo "		</TD>";
echo "		<TD WIDTH=200>";
echo "			<P ALIGN=CENTER><FONT FACE=\"Arial, sans-serif\"><A HREF=\"chlang.php\">Languages</A></FONT></P>";
echo "		</TD>";
echo "		<TD WIDTH=215>";
echo "			<P ALIGN=CENTER><FONT FACE=\"Arial, sans-serif\"><A HREF=\"chport.php\">Change TCP/IP-Port";
echo "			</A></FONT></P>";
echo "		</TD>";
echo "	</TR>";
...
echo "		</TD>";
echo "    <TD WIDTH=200 height=\"26\"> ";
echo "			<P ALIGN=CENTER><FONT FACE=\"Arial, sans-serif\"><A HREF=\"update.php\">Update available?";
echo "			</A></FONT></P>";
echo "</TD>";
echo "    <TD WIDTH=215 > ";
