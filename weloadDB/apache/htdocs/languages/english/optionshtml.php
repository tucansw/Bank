...
echo "<H1><FONT FACE=\"Arial, sans-serif\">Changing Link options<br></H1>";
echo "<BR>";
...
if(is_file($filenamen)){
$ey2=($ey+1);
$filenamen="$copy2$ey$ey2$ext";
}
//
...
<FONT SIZE=1 STYLE=\"font-size: 8pt\">(Open $kopief in new window)</H2></FONT>
</body></html>
"; 
