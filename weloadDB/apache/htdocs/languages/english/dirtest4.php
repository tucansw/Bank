...
echo "Name of Content Package missed!";
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "The names \"upload\" are \"uploads\" reserved!";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=back></FORM>";
exit;
}
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "Content Package exists!<br>";
echo "<br>";
echo "<br>";
echo "<form action=\"overwrite.php?pfad=$verz method=post\">";
echo "<div>";
echo "<button name=\"Loeschen\" type=\"button\" value=\"$verz\" onClick=\"self.location.href='overwrite.php?pfad=$verz'\">";
echo "<img src=\"../images/refresh.gif\" border=0\" alt=\"Update Content Package\">";
echo "</button>&nbsp; &nbsp; &nbsp; update";
echo "</div>";
echo "</form>";

echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=cancel></FORM>";
exit;
}
...
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<P><FONT FACE=\"Arial,sans-serif\">";
echo "Content Package empty.<br>";
echo "You have to upload/create Links first.<br>";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=back></FORM>";
exit;
}
...
echo "<HR>";
echo "<H2><A HREF=\"$pfad\" target=\"_blank\">Preview Content Package</H2>";
echo "</a>";
echo "<form enctype=\"multipart/form-data\" action=\"erzeugen.php\" method=\"post\">";
echo "<P><INPUT type=submit value=back></FORM>";
}
