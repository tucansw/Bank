...
echo "<b>WeLOAD</b> address in the local network:";
echo "<br><H2>$stick</H2>";
unlink ($liste);
...
echo "Free diskspace: " . $var1 . " Megabyte";
echo "<br>";
...
$stick="$http$ipnummer2$web";
echo "<BODY LANG=\"de-DE\" BGCOLOR=\"#c0c0c0\">";
echo "<b>WeLOAD</b> is only available on this computer.";
echo "<br>";
echo "Maybe the LAN is not configured";
echo "<br>";
echo "or there is no connection to the network.";
echo "<br>";
echo "You can work locally in WeLOAD.";
echo "<br>";
echo "<br><H2>$stick</H2>";
unlink ($liste);
