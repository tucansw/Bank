<?php
/* $Id: swedish-iso-8859-1.inc.php,v 2.73.2.1 2005/05/05 17:02:45 lem9 Exp $ */
...
$strMyISAMMaxSortFileSizeDesc = 'Denna maximala storleken för de temporära filer som MySQL är tillåten att använda under återskapande av MyISAM-index (vid REPAIR TABLE, ALTER TABLE, eller LOAD DATA INFILE).';
